...
def get_default_parser():
	...
	parser.add_argument('--data_path', type=str, default="../vae/data")
	parser.add_argument('--img_path', type=str, default="img")
	parser.add_argument('--output_path', type=str, default="")

	parser.add_argument('--dataset', type=str, default="ur5")
	parser.add_argument('--training_digits', type=int, default=None)
	...
	parser.add_argument('--num_filters_in_final_layer', type=int, default=256)
